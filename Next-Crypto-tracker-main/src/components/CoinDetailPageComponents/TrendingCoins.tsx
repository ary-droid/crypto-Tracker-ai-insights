              ...
              return (
                <div key={item.id + index} className="boxshDark w-80 h-44 rounded-md flex flex-col">
                  ...
                  <div className="flex text-sm items-center justify-between pl-3 pr-8 mb-3">
                   ...
                   <p className={item.price_change_percentage_24h > 0 ? "text-green-600" : "text-red-600"}> <span className='text-black font-semibold'>change:</span> {item.price_change_percentage_24h != null ? item.price_change_percentage_24h.toFixed(2) : "N/A"}%</p>
                  </div>
